...
public class MainActivity extends AppCompatActivity implements AddCityFragment.AddCityDialogListener,EditCityFragment.EditCityDialogListener {
    ...
    public void updateCityList(City city, String name, String province){
        city.setName(name);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //find a way to detect onSetItemOnClick for the list in order to do the edit city function
        cityList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                City selectedItem = (City) parent.getItemAtPosition(position);
                EditCityFragment editFragment = EditCityFragment.newInstance(selectedItem);
